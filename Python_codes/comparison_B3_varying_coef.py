...
coef1 = 3.0
coef2 = 1.0
coef3_vec = [0.1,0.5,1.0,3.0]  ##varying B3 coef
sd1 = 0.1
sd2 = 0.5
sd3 = 1.0
...
def simulation(seed_base):
    ...
    B3_mat = np.full([len(coef3_vec), n3], np.nan)
    for i in range(len(coef3_vec)):
        data.simB3(coef3_vec[i], sd3)
        B3_mat[i,:] = data.B3
    ...
    cost_tune = np.zeros(len(coef3_vec))
    lam2_tune = np.zeros(len(coef3_vec))
    lam3_tune = np.zeros(len(coef3_vec))
    cost_opt = np.zeros(len(coef3_vec))
    lam2_opt = np.zeros(len(coef3_vec))
    lam3_opt = np.zeros(len(coef3_vec))
    acc_all_tune = np.zeros(len(coef3_vec))
    acc_all_opt = np.zeros(len(coef3_vec))
    acc_all_1CV = np.zeros(len(coef3_vec))
    acc_all_allCV = np.zeros(len(coef3_vec))
    acc_indpt_tune = np.zeros(len(coef3_vec))
    acc_indpt_opt = np.zeros(len(coef3_vec))
    acc_indpt_1CV = np.zeros(len(coef3_vec))
    acc_indpt_allCV = np.zeros(len(coef3_vec))
    evf_B1_tune = np.zeros(len(coef3_vec))
    evf_B1_opt = np.zeros(len(coef3_vec))
    evf_B1_1CV = np.zeros(len(coef3_vec))
    evf_B1_allCV = np.zeros(len(coef3_vec))
    evf_B2_tune = np.zeros(len(coef3_vec))
    evf_B2_opt = np.zeros(len(coef3_vec))
    evf_B2_1CV = np.zeros(len(coef3_vec))
    evf_B2_allCV = np.zeros(len(coef3_vec))
    evf_B3_tune = np.zeros(len(coef3_vec))
    evf_B3_opt = np.zeros(len(coef3_vec))
    evf_B3_1CV = np.zeros(len(coef3_vec))
    evf_B3_allCV = np.zeros(len(coef3_vec))
    ts_tune = np.zeros(len(coef3_vec))
    ts_opt = np.zeros(len(coef3_vec))
    ts_1CV = np.zeros(len(coef3_vec))
    ts_allCV = np.zeros(len(coef3_vec))
    time_1CV = np.zeros(len(coef3_vec))
    time_allCV = np.zeros(len(coef3_vec))
    time_tune = np.zeros(len(coef3_vec))

    for index in range(len(coef3_vec)):
